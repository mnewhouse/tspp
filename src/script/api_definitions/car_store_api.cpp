...
namespace ts
{
    namespace script_api
    {
        ...
        template <>
        struct Delegate_traits<resources::Car_handle>
        {
            static Range<const Member_function_definition*> member_functions();
        };
    }
...
ts::Range<const ts::script::Member_function_definition*> ts::script_api::Delegate_traits<ts::resources::Car_handle>::member_functions()
{
    return make_range(std::begin(car_handle::member_functions), std::end(car_handle::member_functions));
}
...
ts::script::API_definition ts::script_api::car_store_api(const resources::Car_store* global_car_store)
{
    ...
    result.delegates.push_back(create_delegate_definition<resources::Car_handle>());
...
SQInteger ts::script_api::car_handle::getCarName(HSQUIRRELVM vm)
{
    ...
    {
        const auto& car_name = (*car_handle_udata)->car_name;
