...
namespace ts
{
    namespace world
    {
        ...
        public:
            ...
            void remove_control_point_listener(Control_point_listener* listener);
            ...
            void test_control_point_intersection(Entity* entity, Vector2i old_position, Vector2i new_position) const;
