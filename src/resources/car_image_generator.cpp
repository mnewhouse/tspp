...
namespace ts
{
    namespace resources
    {
        namespace impl
        {
            ...
            Color_map make_color_map(Vector2i frame_size, Double_rect car_bounds, const Player_color& player_color);
...
sf::Image ts::resources::Car_image_generator::operator()(const Car_definition& car_definition, const Player_color& color_scheme, Frame_mode frame_mode) const
{
...
sf::Color ts::resources::impl::colorize(sf::Color source_color, sf::Color target_color)
{
...
ts::resources::impl::Color_map::Color_map(Vector2i frame_size_)
: pixels(frame_size_.x * frame_size_.y),
  frame_size(frame_size_)
{}

ts::resources::impl::Color_map ts::resources::impl::make_color_map(Vector2i frame_size, Double_rect car_bounds, const resources::Player_color& player_color)
{
...
ts::Int_rect ts::resources::impl::calculate_absolute_area(Double_rect area, Vector2i frame_size)
{
...
void ts::resources::impl::apply_base_component(Color_map& color_map, Double_rect car_bounds, const resources::Color_base& base)
{
...
sf::Color ts::resources::impl::blend_alpha(sf::Color source, sf::Color dest)
{
...
void ts::resources::impl::apply_extra_component(Color_map& color_map, Double_rect car_bounds, const resources::Color_extra& component)
{
...
sf::Color ts::resources::impl::interpolate_color(sf::Color first, sf::Color second, double value)
{
...
void ts::resources::impl::fill_with_color(Color_map& color_map, Double_rect area, sf::Color color)
{
    auto& pixels = color_map.pixels;
    auto frame_size = color_map.frame_size;
...
ts::Double_rect ts::resources::impl::find_image_bounds(const sf::Image& image, Int_rect rect)
{
...
void ts::resources::impl::apply_horizontal_gradient(Color_map& color_map, Double_rect area, sf::Color primary, sf::Color secondary)
{
    auto& pixels = color_map.pixels;
    auto frame_size = color_map.frame_size;
...
void ts::resources::impl::apply_vertical_gradient(Color_map& color_map, Double_rect area, sf::Color primary, sf::Color secondary)
{
    auto& pixels = color_map.pixels;
    auto frame_size = color_map.frame_size;
