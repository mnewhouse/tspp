...
ts::resources::Image_load_error::Image_load_error(utf8_string file_path)
: std::logic_error("failed to open image " + file_path.string()),
  file_path_(std::move(file_path))
{
}

const ts::utf8_string& ts::resources::Image_load_error::file_path() const
{
    return file_path_;
}

const sf::Image* ts::resources::Image_loader::load_from_file(const utf8_string& file_name, std::nothrow_t)
{
...
const sf::Image& ts::resources::Image_loader::load_from_file(const utf8_string& file_name)
{
...
const sf::Image* ts::resources::Image_loader::load_from_file_impl(const utf8_string& file_name)
{
