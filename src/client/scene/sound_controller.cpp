...
ts::scene::Sound_controller::Sound_controller(resources::Audio_settings audio_settings, audio::Loaded_sound_effects sound_effects)
...
void ts::scene::Sound_controller::update(std::size_t frame_duration)
{
...
void ts::scene::Sound_controller::start()
{
    engine_sounds.start();
}
