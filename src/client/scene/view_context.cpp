...
ts::scene::View::View(Vector2u screen_size, Vector2u world_size)
: camera(screen_size, world_size),
  view_port(0.0, 0.0, 1.0, 1.0)
{
}

ts::scene::View_context::View_context(Vector2u screen_size, Vector2u world_size)
: screen_size_(screen_size),
  world_size_(world_size)
{
}

ts::Vector2u ts::scene::View_context::screen_size() const
{
    return screen_size_;
}

ts::scene::View* ts::scene::View_context::add_view()
{
...
std::size_t ts::scene::View_context::view_count() const
{
    return views_.size();
}

void ts::scene::View_context::clear()
{
    views_.clear();
}

const ts::scene::View& ts::scene::View_context::view(std::size_t view_index) const
{
    return views_[view_index];
}

ts::scene::View& ts::scene::View_context::view(std::size_t view_index)
{
    return views_[view_index];
}

const ts::scene::View* ts::scene::View_context::begin() const
{
    return views_.data();
}

ts::scene::View* ts::scene::View_context::begin()
{
    return views_.data();
}

const ts::scene::View* ts::scene::View_context::end() const
{
    return views_.data() + views_.size();
}

ts::scene::View* ts::scene::View_context::end()
{
    return views_.data() + views_.size();
}

void ts::scene::View_context::arrange_evenly()
{
