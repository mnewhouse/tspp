...
ts::scene::Track_component::Track_component(std::vector<sf::Vertex> vertices, const sf::Texture* texture, std::uint32_t level)
: vertices(std::move(vertices)), texture(texture), level(level)
{
}

ts::Int_rect ts::scene::impl::Target_texture::allocate_tile_space(Vector2i size)
{
...
void ts::scene::impl::Target_texture::deallocate_tile_space(Int_rect area)
{
...
ts::scene::Track_scene::Track_scene(Vector2u track_size)
: track_size(track_size)
{
}

ts::scene::Track_scene::Track_scene(Track_scene&& other)
...
ts::scene::Track_scene& ts::scene::Track_scene::operator=(Track_scene&& other)
{
    components = std::move(other.components);
    textures = std::move(other.textures);
    track_size = other.track_size;
...
ts::scene::Track_builder::Track_builder(const resources::Track& track)
: track_(track), result_(track.size())
{
    create_new_target_texture();
}

void ts::scene::Track_builder::preload_image(const utf8_string& path)
{
...
/*
const ts::utf8_string& ts::scene::Track_builder::resolve_path(const utf8_string& path)
{
...
void ts::scene::Track_builder::add_large_tile(const resources::Placed_tile& placed_tile, Int_rect image_rect)
{
...
std::pair<ts::scene::impl::Target_texture*, ts::Int_rect> ts::scene::Track_builder::allocate_tile_space(Int_rect image_rect)
{
...
std::size_t ts::scene::Track_builder::step_count() const
{
    return track_.placed_tiles().size() * 2;
}

void ts::scene::Track_builder::generate_texture(impl::Target_texture& target_texture)
{
...
void ts::scene::Track_builder::build_tile_mapping(impl::Target_texture& target_texture)
{
...
void ts::scene::Track_builder::build_scene(std::function<void()> step_operation)
{
...
void ts::scene::Track_builder::add_tile_to_scene(const Tile_entry& tile_entry)
{
...
void ts::scene::Track_builder::add_tile(const resources::Placed_tile& placed_tile)
{
    auto target_texture = current_target_texture_;
...
void ts::scene::Track_builder::add_tile_entry(const resources::Placed_tile& placed_tile, impl::Target_texture* target_texture)
{
    tile_entries_.push_back({ placed_tile, target_texture });
}

ts::scene::impl::Target_texture* ts::scene::Track_builder::create_new_target_texture()
{
...
void ts::scene::Track_builder::calculate_bounding_boxes()
{
...
void ts::scene::Track_builder::add_edge_component()
{
...
ts::scene::Track_scene ts::scene::Track_builder::operator()(std::function<void()> step_operation)
{
