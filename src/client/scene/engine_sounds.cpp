...
ts::scene::Engine_sound_controller::Engine_sound_controller(resources::Audio_settings audio_settings, audio::Audio_store engine_sounds)
...
void ts::scene::Engine_sound_controller::sort_sounds_by_locality()
{
...
void ts::scene::Engine_sound_controller::play_prioritized_sounds()
{
    std::size_t index = 0;
...
void ts::scene::Engine_sound_controller::unregister_car(const world::Car* car)
{
...
void ts::scene::Engine_sound_controller::start()
{
    started_ = true;
}