...
#include "server/server_interaction_listener.hpp"
...
namespace ts
{
    namespace server
    {
        ...
        {
        public:
            Interaction_event_listener(Interaction_interface* interaction_interface, Script_engine* script_engine, const Client_map* client_map);
