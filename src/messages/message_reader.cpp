...
ts::messages::Message_reader::Message_reader(const Message& message)
: ptr_(message.data()),
  end_(message.data() + message.size())
{
}

ts::messages::Message_reader::operator bool() const
{
    return !failbit_;
}

void ts::messages::Message_reader::reset(const Message& message)
{
    failbit_ = false;
    ptr_ = message.data();
...
void ts::messages::Message_reader::advance(std::uint32_t offset)
{
    ptr_ += offset;
}
...
ts::messages::Message_reader& ts::messages::Message_reader::operator>>(std::uint32_t& value)
{
    if (!*this || end_ - ptr_ < 4)
    {
        failbit_ = true;
...
ts::messages::Message_reader& ts::messages::Message_reader::operator>>(std::uint16_t& value)
{
    if (!*this || end_ - ptr_ < 2)
    {
        failbit_ = true;
...
ts::messages::Message_reader& ts::messages::Message_reader::operator>>(std::uint8_t& value)
{
    if (!*this || end_ - ptr_ < 1)
    {
        failbit_ = true;
...
ts::messages::Message_reader& ts::messages::Message_reader::operator>>(std::int64_t& value)
{
    std::uint64_t uvalue;
    if (*this >> uvalue)
    {
...
ts::messages::Message_reader& ts::messages::Message_reader::operator>>(std::int32_t& value)
{
    std::uint32_t uvalue;
    if (*this >> uvalue)
    {
...
ts::messages::Message_reader& ts::messages::Message_reader::operator>>(std::int16_t& value)
{
    std::uint16_t uvalue;
    if (*this >> uvalue)
    {
...
ts::messages::Message_reader& ts::messages::Message_reader::operator>>(std::int8_t& value)
{
    std::uint8_t uvalue;
    if (*this >> uvalue)
    {
