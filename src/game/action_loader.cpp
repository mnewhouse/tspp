...
ts::utf8_string ts::game::to_string(Action_loader_state state)
{
    switch (state)
    {
    case Action_loader_state::Building_track_scene:
        return "Building track scene...";

    case Action_loader_state::Loading_entity_textures:
    case Action_loader_state::Loading_track_textures:
