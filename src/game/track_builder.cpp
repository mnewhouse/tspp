...
namespace ts
{
    ...
    namespace game
    {
        ...
        void add_sub_tile(Track_builder_result& result, graphics::Texture_loader& texture_loader,
...
void ts::game::add_sub_tile(Track_builder_result& result, graphics::Texture_loader& texture_loader,
                    const resources::Track& track, const resources::Tile_definition& tile_def,
                    const resources::Level_tile& tile, const resources::Level_tile& sub_tile)
{
...
void ts::game::optimize_component_list(std::vector<Track_component>& components)
{
...
void ts::game::calculate_bounding_boxes(std::vector<Track_component>& components)
{
...
ts::game::Track_builder_result ts::game::build_track(const resources::Track& track)
{
