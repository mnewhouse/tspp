...
: Cup_state_base(game::Cup_type::Remote, state_machine, context, resource_store)
{
}
...
{
    return std::make_unique<Client_action_state>(std::move(loaded_scene), state_machine(), context(), resource_store());
}